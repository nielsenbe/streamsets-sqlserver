...
RUN tar -xvzf /path/to/yourfile.tgz /opt/streamsets-datacollector-user-libs/streamsets-datacollector-snowflake-lib-1.0.1/streamsets-datacollector-snowflake-lib-1.0.1.tgz
